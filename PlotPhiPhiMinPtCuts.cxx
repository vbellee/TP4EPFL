...
void PlotPhiPhiMinPtCuts (float InputStartRange, float InputStopRange) {
...
TFile *in_file = TFile::Open("/../../lhcb/panasas/radiative/TupleProd/MC11a/2011/Bs2PhiPhiGamma/VVG/S20r1/Bs2PhiPhiGamma_2011_S20r1_VVG.root");
 ...
 TH1F* hMinKplus0Kminus0Sig=new TH1F("MinKplus0Kminus0","{Kplus0,Kminus0} Min Pt",
                        100,//Number of bins
                        InputStartRange,//Lower X Boundary
                        InputStopRange);//Upper X Boundary
 hMinKplus0Kminus0Sig->SetFillColor(kBlue-9);

 TH1F* hMinKplus0Kminus0LBkG=new TH1F("MinKplus0Kminus0","{Kplus0,Kminus0} Min Pt",
                        100,//Number of bins
                        InputStartRange,//Lower X Boundary
                        InputStopRange);//Upper X Boundary
 hMinKplus0Kminus0LBkG->SetLineColor(kBlue+1);

 TH1F* hMinKplus0Kminus0HBkG=new TH1F("MinKplus0Kminus0","{Kplus0,Kminus0} Min Pt",
                        100,//Number of bins
                        InputStartRange,//Lower X Boundary
                        InputStopRange);//Upper X Boundary
 hMinKplus0Kminus0HBkG->SetLineColor(kRed+1);
 ...
 while (my_tupleSignal->GetEntry(entrySig) ){
   ...
   if ((B_MM>LowerLimit)&&(B_MM<UpperLimit)){
     ...
     hMinKplus0Kminus0Sig->Fill(min(Kplus0_PT,Kminus0_PT));
     hMinSig->Fill(min(min(Kplus0_PT,Kminus0_PT),min(Kminus_PT,Kplus_PT)));
     hB_MMSig->Fill(B_MM);
   }
 ...
 while ( my_chainBkG->GetEntry(entryBkG) ) {
   ...
   if(B_MM<LowerLimit){
     ...
     hMinKplus0Kminus0LBkG->Fill(min(Kplus0_PT,Kminus0_PT));
     hMinLBkG->Fill(min(min(Kplus0_PT,Kminus0_PT),min(Kminus_PT,Kplus_PT)));
     ...
     hMinKplus0Kminus0HBkG->Fill(min(Kplus0_PT,Kminus0_PT));
     hMinHBkG->Fill(min(min(Kplus0_PT,Kminus0_PT),min(Kminus_PT,Kplus_PT)));
 ...
 cCanvas->cd(2);
 // hMinKplus0Kminus0LBkG->Scale(1/NumEntriesBkG);
 hMinKplus0Kminus0Sig->DrawNormalized();
 //hMinKplus0Kminus0HBkG->Scale(1/NumEntriesBkG);
 hMinKplus0Kminus0HBkG->DrawNormalized("same");
 //hMinKplus0Kminus0Sig->Scale(1/NumEntriesSig);
 hMinKplus0Kminus0LBkG->DrawNormalized("same");
